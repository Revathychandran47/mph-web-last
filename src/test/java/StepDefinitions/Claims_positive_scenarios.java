...
public class Claims_positive_scenarios extends Generic_function{
	...
	public void My_medicare_claims_positive_positive_tc_002() throws Exception {
		try {
			browser_explicit_wait("claims_select_claim_type_text",360);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void My_medicare_claims_positive_positive_tc_010() throws Exception {
		try {
			click_javascript("claims_prescription_drug_claim");
			browser_explicit_wait("claims_claim_number",360);
		} catch (Exception e) {
			e.printStackTrace();
