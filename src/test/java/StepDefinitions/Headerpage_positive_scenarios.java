...
public class Headerpage_positive_scenarios extends Generic_function {
	...
	public static void verify_navigation_to_help() throws Exception {
		try {
			value = driver.findElement(By.xpath(OR_reader( "header_FAQ"))).isDisplayed();
			Assert.assertEquals(true,value);
			browser_back();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void verify_navigation_to_alerts() throws Exception {
		try {
			browser_explicit_wait("header_alerts_title",10);
	...
	public void click_your_profile() throws Exception {
		click("header_profile");
		browser_explicit_wait("header_profile_title",10);
	}
	...
	public static void verify_navigation_to_ratings() throws Exception {
		try {
			value = driver.findElement(By.xpath(OR_reader( "header_ratings_title"))).isDisplayed();
			Assert.assertEquals(true,value);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void verify_navigation_to_feedback() throws Exception {
		try {
			browser_handle();
			value = driver.findElement(By.xpath(OR_reader("header_feedback_title"))).isDisplayed();
			Assert.assertEquals(true,value);
			browser_close();
			browser_switch();
		} catch (Exception e) {
